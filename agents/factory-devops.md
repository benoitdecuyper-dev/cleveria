...
- Ne déclare un déploiement réussi qu'après **vérification réelle** (santé du service, smoke test) — pas seulement « le pipeline est vert ».
