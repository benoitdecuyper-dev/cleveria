...
## Méthode
1. **Poser les hypothèses** explicitement (volumes, prix, coûts unitaires, délais) — elles doivent être traçables et discutables.
...
- Sois prudent : préfère sous-estimer les recettes et sur-estimer les coûts ; signale les angles morts (BFR, saisonnalité, imprévus).
