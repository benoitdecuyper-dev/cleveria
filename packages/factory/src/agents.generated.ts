...
export const AGENTS: FactoryAgent[] = [
  ...
  },
  {
    ...
    "description": "Orchestrateur / planificateur de la Factory team — à partir d'une note de cadrage validée, établit le PLAN DE TRAVAIL (quels agents mobiliser, dans quel ordre, avec quelle consigne chacun) sous forme de DAG d'étapes. Il ne fait pas le travail lui-même : il distribue. Mobilisé par le moteur juste après le GO de l'utilisateur. Exemples — \"établis le plan de travail de l'équipe\", \"qui fait quoi sur ce projet\", \"découpe ce cadrage en étapes pour les agents\".",
    "tools": [
      "Read",
      "Grep",
      "Glob"
