...
- **🟦 CLV-53** — Fusion `/echange`+`/voice` + passerelle promotion-en-place. Plan dé-risqué en 6 incréments : `docs/26`. Base retenue (GO Ben) : garder `/voice`, lâcher l'orbe en V1. Avancement : **✅ incr. 1** (passerelle promotion-en-place, `242111d`) · **✅ durcissement** verrou par id (`6d3fde2`, arme l'incr. 3) · ⬜ incr. 2-6. Chaque incr. = dev → lead-tech → QA → 1 commit vert.
